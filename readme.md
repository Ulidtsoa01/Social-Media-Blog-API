...
This project is a backend for a hypothetical social media app that serves to manage user accounts and and the messages they post. It uses Javalin to run the server and JDBC to connect to a database. The available endpoints include handling user registration, login, message creations, message updates, and message deletions.
